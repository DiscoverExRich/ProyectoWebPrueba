<?php require_once('../Connections/conexionpaginaweb.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  mysql_select_db($database_conexionpaginaweb, $conexionpaginaweb);
  $Result1 = mysql_query($insertSQL, $conexionpaginaweb) or die(mysql_error());
...
<title>Administraci&oacute;n AyZWeb</title>
<!-- InstanceEndEditable -->
...
<div class="container">
  ...
  <div class="content"><!-- InstanceBeginEditable name="parteDerechaAdmin" -->
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Imagen Grande(730x250px):</td>
          <td><input type="text" name="strImagenGrande" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Imagen Peque&ntilde;a(80x50px):</td>
          <td><input type="text" name="strImagenPequena" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Subt&iacute;tulo:</td>
